          ...
          <header className="border-b border-slate-200 pb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-slate-200 bg-white px-2.5 py-1 text-xs font-medium text-slate-600 shadow-sm transition hover:bg-slate-50 hover:text-slate-900 print:hidden"
              >
            ...
            <div className="grid gap-6 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
              <div>
                <h1 className="text-2xl font-semibold text-slate-900">Proposal Overview</h1>
