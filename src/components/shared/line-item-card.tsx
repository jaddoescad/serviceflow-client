      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className={`py-2 text-sm font-semibold ${isDiscount ? "text-rose-600" : "text-slate-900"}`}>
              {isDiscount ? "-" : ""}{formatCurrency(Math.abs(Number.parseFloat(unitPrice) || 0))}
            </p>
          </div>
        </div>
        {error && (
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <p className={`text-sm font-medium ${isDiscount ? "text-rose-600" : "text-slate-900"}`}>
